...
const metrics = [
  { value: 50000, suffix: "+", prefix: "", label: "Jobs scraped daily across all sources" },
  { value: 92, suffix: "%", prefix: "", label: "Average AI match accuracy score" },
  { value: 6, suffix: "", prefix: "", label: "Job boards covered in every search" },
  { value: 2, suffix: " min", prefix: "<", label: "From onboarding to first results" },
];
